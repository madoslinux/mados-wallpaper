...
class WallpaperApp(Gtk.Application):
    ...
    def _show_mode_selector(self, workspace: int, file_path: str, current_mode: str):
        ...
        for mode, desc in [("fill", "Fill (cover screen)"), ("fit", "Fit (keep aspect)"), ("center", "Center"), ("stretch", "Stretch"), ("tile", "Tile")]:
        ...
        key_controller.connect("key-pressed", lambda c, k, kc, s: mode_dialog.destroy() if k == Gdk.KEY_Escape else False)
